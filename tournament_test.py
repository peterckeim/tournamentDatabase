...
def testRegister():
	...
	deletePlayers()
	deleteTournaments()
	registerTournament("Battle Royale")
...
def testRegisterCountDelete():
	...
	deleteTournaments()
	registerTournament("Battle Royale")
	registerTournament("Whose Got the Best Badger?")
...
def testStandingsBeforeMatches():
	deleteMatches()
	deletePlayers()
	registerTournament("The Dinkle Derby")
...
def testReportMatches():
	...
	deletePlayers()
	deleteTournaments()
	registerTournament("Kitten Kombat")
...
def testPairings():
	...
	deletePlayers()
	deleteTournaments()
	registerTournament("TMNT Comeback Tour")
